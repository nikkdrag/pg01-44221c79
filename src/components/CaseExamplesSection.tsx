        ...
        <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
          {openCase && (
            <>
              ...
              <div className="mt-4">
                <h4 className="font-bold mb-2">Вопрос:</h4>
                <p className="whitespace-pre-line mb-6">{openCase.question}</p>
                <h4 className="font-bold mb-2">Ответ:</h4>
                <p className="whitespace-pre-line">{openCase.answer}</p>
              </div>
            </>
          )}
        </DialogContent>
